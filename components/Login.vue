<template>
    <section class="flex bg-[#131619] min-h-screen font-jakarta">
        <div class="w-1/2 flex flex-col">
            ...
            <div class="flex flex-col mt-32 ml-48">
                ...
                <div class="flex flex-col gap-3 w-full mb-8">
                    <div class="flex w-full">
                        <input type="email" placeholder="Email" class="border-2 border-[#363A3D] bg-[#1A1D21] w-9/12 text-lg text-[#9B9C9E] px-2 py-2 rounded-lg">
                    </div>
                    <div>
                        <input type="password" name="" id="" placeholder="Senha" class="border-2 border-[#363A3D] bg-[#1A1D21] w-9/12 text-lg text-[#9B9C9E] px-2 py-2 rounded-lg">
                    </div>
                </div>
